...
public class ConsumerDemoWithThreads {
    ...
    private void run() {
        ...
        // this latch is for dealing with multiple threads
    ...
    public class ConsumerRunnable implements Runnable {
        ...
        public ConsumerRunnable(String bootstrapServers, String groupId, String topic, CountDownLatch latch) {
            ...
            // subscribing the consumer to the topics
        ...
        public void run() {
            try {
                ...
                consumer.close();
                latch.countDown(); // tells the code that we are done with the consumer
            }
        ...
        public void shutdown() {
            ...
            // this throws exception WakeUpException
            consumer.wakeup();
        }
    }
}
